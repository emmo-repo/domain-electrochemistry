# Sphinx configuration for the Electrochemistry Domain Ontology (ECHO) docs.
#
# The class index page (electrochemistry.rst) is generated by CI from the
# ontology sources via .github/scripts/ontology_toolkit.py --generate-rst;
# a local build uses whatever was last committed.
...
project = 'Electrochemistry Domain Ontology (ECHO)'
copyright = '2021-2026, the EMMO Electrochemistry contributors'
author = 'Simon Clark'
...
# of the sidebar.
html_logo = 'assets/img/fig/png/domain-electrochemistry-logo.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.
html_favicon = 'assets/img/fig/png/domain-electrochemistry-logo.png'
