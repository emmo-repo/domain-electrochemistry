...
What is a Graph?
"""""""""""""""
A graph is a set of connected triples. Each triple can be visualized as two nodes (the subject and object) connected by an arrow (the predicate). When multiple triples share common nodes, they form a network structure.
...
**Star** (one subject, many properties) 
